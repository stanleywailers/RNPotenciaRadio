...
export const CustomDrawer = ({}) => {
  return (
    <Drawer.Navigator  
    screenOptions= {({navigation}) => ({ headerLeft: () =>
      <TouchableOpacity  onPress={() =>  navigation.dispatch(DrawerActions.openDrawer()) }>
      <Icon name="reorder-three-sharp" size={40} color="black" style={{marginLeft:10}} />
    </TouchableOpacity>
    })}
    ...
    <Drawer.Screen  options={ () => ({ title:'Inicio'})} name="HomeScreen" component={HomeScreen}  />
    <Drawer.Screen options={ () => ({ title:'Noticias'})} name="NewsScreen" component={NewsScreen} />
    <Drawer.Screen options={ () => ({ title:'Configuraciones'})} name="SettingsScreen" component={SettingsScreen} />
